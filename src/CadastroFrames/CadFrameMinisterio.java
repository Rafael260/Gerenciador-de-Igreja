...
public class CadFrameMinisterio extends javax.swing.JFrame implements BuscadorDeMembro {
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        String nome = testeEmpty(txtNome.getText());
        String descricao = testeEmpty(txtDescricao.getText());
        String diaSemana = testeEmpty((String)comboDiaSemana.getSelectedItem());
        ...
        ministerio.setLider(membroSelecionado);
        ministerio.setDiaSemana(diaSemana);
        try{
            Ministerio.cadastrarOuAtualizarMinisterio(ministerio);
            JOptionPane.showMessageDialog(null, "Ministério cadastrado com sucesso");           
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, "Houve um problema ao tentar cadastrar");
        }
        gerenciador.refresh();    
    ...
    public void setMembroSelecionado(Membro membroSelecionado) {
        ...
        lbNomeLider.setText(membroSelecionado.getPessoa().getNome());
    }

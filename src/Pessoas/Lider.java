...
public class Lider extends Membro {
    ...
    public Lider(String cpf, Date data_nascimento, boolean lider, boolean professor, int id, String nome, String sobrenome, char estado_civil, String numero_telefone, Endereco endereco) {
